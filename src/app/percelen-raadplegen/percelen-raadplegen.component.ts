...
@Component({
  selector: 'app-percelen-raadplegen',
  templateUrl: './percelen-raadplegen.component.html',
  styleUrls: ['./percelen-raadplegen.component.scss'],
  standalone: true,
  imports: [IonicModule, CommonModule],
})
export class PercelenRaadplegenComponent implements OnInit {
  userEmail: string = '';
  error: string = '';
  ...
  async fetchPercelen() {
    ...
    await this.perceelService.getPercelen().subscribe((percelen) => {
      ...
      this.percelenLijst = this.percelenLijst;
      this.isLoading = false;
    })
  }
}
